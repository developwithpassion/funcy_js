import { identity, iif, noOp, constant, compose, pipe, prop, reducer_for_unique_map, tap } from './core';
...
describe('core functional utils', () => {
  ...
  describe('iif', () => {
    ...
    describe('when the condition is true', () => {
      ...
      it('runs the true func', () => {
        expect(result).toEqual(trueFunc);
      });
    });
    ...
    describe('when the condition is false', () => {
      ...
      it('runs the false func', () => {
        expect(result).toEqual(falseFunc);
      });
    });
  });
});
